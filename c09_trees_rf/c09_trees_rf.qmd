...
נגדיר איזשהו פרמטר עונש על גודל העץ אלפא, כך שעבור כל צומת וצומת שבדיעבד פיצלנו, אפשר להסתכל על הRSS שם ולהוסיף לו עונש אלפא כפול גודל העץ, כלומר כמה צמתים או כמה עלים יש בו, בנקודת הזמן הזאת.
...
- Two more natural choices in trees:
  ...
  - If observation $\mathbf{x}_i$ is missing element $x_{ij}$ for split $(j, s)$ --- send it both left and right!
