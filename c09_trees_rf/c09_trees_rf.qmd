...
- Unordered categorical variables:
  - All subsets exhaustive search? Two main issues:
  - Grouping for values with too few observations
  - CART approach:
    - For each category $h_q$ denote $\bar{y}_q$ the average of the observations of class $q$ in the current node.
...
- Handles all types of predictors (continuous, categorical)
