...
- As before, we have $T = (X,y)$ a sample of size $n$
...
::: {.notes}
::: {style="direction:rtl; font-size:16px"}
כאן אנחנו רואים הדגמה של הפונקציה הזאת עם נתונים עבור חותך בטא-אפס ושיפוע של משתנה נוסף, בטא-אחת. ממש ניתן לראות כיצד הפונקציה קעורה או קמורה כלפי מעלה, מה שאומר שמובטח לנו שבכמה צעדי גרדיאנט נגיע לנקודת המינימום של הבטאות ושהיא מינימום גלובלי.
:::
:::
...
עד כאן לגבי מודלים ליניאריים. כאמור מדובר במודלים המפורסמים והנחקרים ביותר, הם עדיין בשימוש נרחב בתעשייה ולו בתור בייסליין שניתן לסמוך עליו, בייסליין שבאופן מפתיע הרבה פעמים קשה לנצח.
:::
:::
