...
::: {.notes}
::: {style="direction:rtl; font-size:16px"}
כבר אמרנו שרגרסיה ליניארית הוא אחד המודלים הנחקרים ביותר בספרות, זה אומר שעל כל ניואנס בו נכתבו תלי תלים של מאמרים. לסיכום הנושא נזכיר שתי בעיות שצריך להיות מודעים אליהן ולקרוא עוד קצת על הטיפול בהן: קוליניאריות ותצפיות חריגות.
:::
:::
...
אם בנוסף ערך הY של נקודה כזאת גם חריג, זה אומר שיש לנו תצפית חריגה עם מנוף גבוה - אאוטלייר - היא יכולה להטות את המודל לגמרי. בואו נראה דוגמא.
:::
:::
...
::: {.notes}
::: {style="direction:rtl; font-size:16px"}
כאן אנחנו רואים הדגמה של הפונקציה הזאת עם נתונים עבור חותך בטא-אפס ושיפוע של משתנה נוסף, בטא-אחת. ממש ניתן לראות כיצד הפונקציה קעורה או קמורה כלפי מעלה. נהפוך אותה אם ניקח פשוט מינוס והיא תהיה קעורה, מה שאומר שמובטח לנו שבכמה צעדי גרדיאנט נגיע לנקודת המינימום של הבטאות ושהיא מינימום גלובלי, למינוס הנראות.
:::
:::
