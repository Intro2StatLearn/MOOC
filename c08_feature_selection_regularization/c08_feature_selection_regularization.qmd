...
::: {.incremental}
- Numerical stability:
  - If $X$'s columns are highly correlated, $X'X$ is ill-conditioned and its inverse is unstable, variance of $\hat{\beta}$ is high -- but $X'X + \lambda I_p$ improves on this
- Feasibility:
