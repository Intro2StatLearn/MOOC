...
::: {.notes}
::: {style="direction:rtl; font-size:16px"}
שתי הערות לגבי התוצאה שקיבלנו.

הערה ראשונה: איזו טעות נרצה שתהיה קטנה? שתיהן, אבל את האירדוסיבל ארור אנחנו לא יכולים באמת להפחית, היא נובעת מהרעש הטבעי שבנתונים, והמיקוד שלנו יהיה להפחית את הטעות הרידוסיבל, לדאוג שהחיזוי שלנו יהיה כמה שקרוב לפונקציה f.
