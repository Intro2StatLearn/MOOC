...
::: {.incremental}
- If $y$ is the number of snacks in a bag: "noise" is intuitive, sometime 101 snacks, sometimes 99
...
- And it absolutely can be dependent on $x$ (e.g. $Var(\varepsilon|x) = \sigma(x)^2$)
:::
