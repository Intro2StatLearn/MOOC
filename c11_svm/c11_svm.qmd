...
:::
::: {.fragment}
$\langle h(x_i), h(x_0) \rangle = \begin{pmatrix}1 \\ \sqrt{2}x_{i1} \\ \sqrt{2}x_{i2} \\ x^2_{i1} \\ x^2_{i2} \\ \sqrt{2}x_{i1}x_{i2}\end{pmatrix}^T\begin{pmatrix}1 & \sqrt{2}x_{01} & \sqrt{2}x_{02} & x^2_{01} & x^2_{02} & \sqrt{2}x_{01}x_{02}\end{pmatrix}=$
$= (1 + x_i^Tx_0)^2$
:::
