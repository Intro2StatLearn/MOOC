...
::: {.fragment}
PCA solution also minimizes the reconstruction error of a linear encoder/decoder system!
:::
...
- So we're looking for the set of $W_{p \times p}$ eigenvectors of $X^TX$ with their corresponding eigenvalues $\lambda_1, \dots, \lambda_p$ ordered from largest to smallest
:::
