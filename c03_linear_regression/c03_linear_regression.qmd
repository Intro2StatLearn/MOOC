...
::: {.fragment}
::: {.callout-note}
So, consider adding all possible interaction terms?
:::
:::
::: {.fragment}
::: {.callout-note}
...
Y = 2 * X1 + 1 * X2 + np.random.normal(0, 1, n_samples)
