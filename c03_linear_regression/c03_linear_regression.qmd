...
## Variance of OLS estimators {.title-slide}
...
::: {.fragment}
- Which reduces to $t^2_{obs} \sim T_{n - p - 1}$ when $q = 1$ (testing a single feature given others)
:::
...
- Backward
- Hybrid
- Other more advanced methods: learn later in the course
...
## Other considerations {.title-slide}
